...
namespace Academic_Staff_Engagement_Claim_Processing_System.Data.Models
{
    public class MarksSubmission
    {
         ...
         *
         * This allows us to verify that the file has not changed.
         */
        [Required]
        [MaxLength(64)]
         ...
         *
         * We do not trust the browser supplied value for validation.
         */
        [Required]
        [MaxLength(100)]
         ...
         *
         * It prevents two management users from modifying the same
         * submission simultaneously without detecting the conflict.
         */
        [Timestamp]
