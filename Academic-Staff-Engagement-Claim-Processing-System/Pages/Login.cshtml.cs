...
namespace Academic_Staff_Engagement_Claim_Processing_System.Pages
{
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            // ========================================================
            // TEMPORARY HOD LOGIN
            // REMOVE THIS AFTER THE REAL HOD ACCOUNT IS CREATED
            // AND TESTED SUCCESSFULLY.
            // ========================================================

            if (username == "temp.hod" && Password == "Hod@1234")
            {
                await SignInAsync(
                    username,
                    "HOD",
            ...
            if (hod != null)
            {
                ...
                if (hod.LockoutEndUtc.HasValue &&
                    hod.LockoutEndUtc.Value > DateTime.UtcNow)
                {
                    ErrorMessage =
                        "This account is temporarily locked. Please try again later.";
            ...
            if (dean != null)
            {
                ...
                if (dean.LockoutEndUtc.HasValue &&
                    dean.LockoutEndUtc.Value > DateTime.UtcNow)
                {
                    ErrorMessage =
                        "This account is temporarily locked. Please try again later.";
            ...
            if (management != null)
            {
                ...
                if (management.LockoutEndUtc.HasValue &&
                    management.LockoutEndUtc.Value > DateTime.UtcNow)
                {
                    ErrorMessage =
                        "This account is temporarily locked. Please try again later.";
